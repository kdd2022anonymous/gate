...
class Meta:
    def __init__(self, d_embed, max_depth, max_width):
        assert d_embed % (max_depth * max_width) == 0
        self.max_depth = max_depth
        self.max_width = max_width
        self.num_feat = d_embed // (max_depth * max_width)

def build_tree_pos_enc_meta(tree_pos_enc, d_embed, max_depth, max_width):
    return Meta(d_embed, max_depth, max_width) if tree_pos_enc else None
